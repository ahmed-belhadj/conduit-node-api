...
> ### Node.js (Express.js + Mongoose) RESTful API containing CRUD, authentication and advanced patterns that adhere to the [API spec](https://github.com/ahmed-belhadj/conduit-node-api/blob/master/api/README.md).
